...
public class RegisterCommand implements ActionCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null && !user.getDeleted()) {
            ...
            if (photo200 == null)
                user.setAvatarURL(ServerLocationUtils.getServerPath(request)+"/img/avatarDefault.png");
            else
    ...
    private void sendActivationEmail(User user, HttpServletRequest request) {
        ...
        String activateUrl = ServerLocationUtils.getServerPath(request)+"/register?action=activate" + emailPartUri + hashPartUri;
