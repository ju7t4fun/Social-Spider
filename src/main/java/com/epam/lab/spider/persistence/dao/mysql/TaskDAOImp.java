...
public class TaskDAOImp extends BaseDAO implements TaskDAO {
    ...
    public boolean insert(Connection connection, Task task) throws SQLException {
        Integer newId = insertQuery(connection, SQL_INSERT_QUERY_NEW,
                //set field at #1
                task.getUserId(),
                task.getFilterId(),
    ...
    @Override
    public List<Task> getAllLimited(Connection connection, int userId, int start, int amount) throws SQLException {
        return select(connection, SQL_GET_ALL_LIMITED_QUERY, userId, start, amount);
    }
    @Override
    ...
    @Override
    public List<Task> getAllActiveLimited(Connection connection, int userId, int start, int amount) throws SQLException {
        return select(connection, SQL_GET_ALL_ACTIVE_LIMITED_QUERY, userId, start, amount);
    }
    ...
    @Override
    public List<Task> getAllLimitedAdmin(Connection connection, int start, int amount) throws SQLException {
        return select(connection, SQL_GET_ALL_LIMITED_ADMIN_QUERY, start, amount);
    }
    @Override
