            ...
            <div class="panel-body">
              <div class="tab-content">
                <div id="active" class="tab-pane active">
                  <div class="col-lg-12">
                    <table class="table table-striped table-advance table-hover">
                      <tr><th>ID</th><th>Grabbing</th><th>Posting</th><th>Account</th><th>Type</th><th>Content</th><th>Interval</th><th>On/Off</th></tr>
                      <tr>
                        <td>456423</td>
                        <td>testest</td>
                        <td>testtest</td>
                ...
                <div id="all" class="tab-pane">
                  <div class="col-lg-12">
                    <table class="table table-striped table-advance table-hover">
                      <tr><th>ID</th><th>Grabbing</th><th>Posting</th><th>Account</th><th>Type</th><th>Content</th><th>Interval</th></tr>
                      <tr>
                        <td>456423</td>
                        <td>testest</td>
                        <td>testtest</td>
