                            ...
                            <ul style="margin-left:-30px;">
                                <li>
                                    <table width="100%" style="padding:0 50px;">
                                        ...
                                        <tr>
                                            <td style="text-align:justify;">Vivamus tincidunt eleifend congue. Sed
                                                lacinia ullamcorper fringilla. Suspendisse mi nisi, molestie eget varius
                                                quis, cursus nec felis. Quisque mi tortor, accumsan vitae tempus a,
                                                placerat et est. Mauris eu mauris urna. Quisque ipsum purus, iaculis nec
                                                libero vel, euismod lacinia est. Proin quis mi et velit scelerisque
                                                feugiat. Nunc porttitor, nunc et ultricies scelerisque, velit est
                                                sollicitudin tortor, ut condimentum dolor nulla id sem. In suscipit urna
                                                a nibh bibendum cursus. Sed ex orci, rhoncus at convallis quis, bibendum
                                                ac ex. Proin vulputate lacus tellus, nec sollicitudin nisl congue eget.
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="text-align:right;">
                                                <input type="image"
                                                       ...
                                                       style="margin:0 10px;" alt="Like">
                                                45
                                                <input type="image"
                                                       src="${pageContext.request.contextPath}/img/speaker.png"
                                                       style="margin:0 10px;" alt="Share">
                                                14
                                            </td>
                                        </tr>
                                    </table>
