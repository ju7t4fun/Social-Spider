  ...
  <form class="login-form" action="/login?action=signIn" method="post" id="register_form">
    <div class="login-wrap">
      ...
      <div class="input-group">
        ...
        <l:resource key="login.password"><input type="password" name="password" id="password" class="form-control" placeholder="" style="border-color:#ffffff;" required /></l:resource>
      </div>
      <div class="input-group">
        <span class="input-group-addon"><i class="icon_key_alt"></i></span>
         <l:resource key="confirmpassword"><input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="" style="border-color:#ffffff;" required /></l:resource>
      </div>
