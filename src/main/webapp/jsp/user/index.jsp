                                    ...
                                    <table width="100%" style="padding:0 50px;">
                                        ...
                                        <tr>
                                            <td style="text-align:justify;">
                                                Vivamus tincidunt eleifend congue. Sed lacinia ullamcorper fringilla.
                                                Suspendisse mi nisi, molestie eget varius quis, cursus nec felis.
                                                Quisque mi tortor, accumsan vitae tempus a, placerat et est. Mauris eu
                                                mauris urna. Quisque ipsum purus, iaculis nec libero vel, euismod
                                                lacinia est. Proin quis mi et velit scelerisque feugiat. Nunc porttitor,
                                                nunc et ultricies scelerisque, velit est sollicitudin tortor, ut
                                                condimentum dolor nulla id sem. In suscipit urna a nibh bibendum cursus.
                                                Sed ex orci, rhoncus at convallis quis, bibendum ac ex. Proin vulputate
                                        ...
                                        <tr>
                                            <td>
                                                <img src="${pageContext.request.contextPath}/img/bg-1.jpg" width="600"
                                                     style="margin:20px;">
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <select id="tokenize_focus" multiple="multiple" class="tokenize-sample"
                                        ...
                                        <option value="12">Group 2</option>
                                        <option value="13">Group 3</option>
                                        <option value="14">Group 4</option>
                                        <option value="15">Group 5</option>
                                        <option value="21">Group 1</option>
                                        <option value="22">Group 2</option>
                                        <option value="23">Group 3</option>
                                        <option value="24">Group 4</option>
                                        <option value="25">Group 5</option>
                                        <option value="212">Group 2</option>
                                        <option value="213">Group 3</option>
                                        <option value="214">Group 4</option>
                                        <option value="215">Group 5</option>
                                    </select>
