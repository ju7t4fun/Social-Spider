...
$(document).ready(function () {
    $("#task-save").click(function () {
        ...
        if (source.length > 3) {
            toastrNotification("warning", "[DEMO-MODE] COUNT OF source GROUP more than MAX(3)");
            return
        }
        ...
        if (destination.length > 3) {
            toastrNotification("warning", "[DEMO-MODE] COUNT OF destination GROUP more than MAX(3)");
            return
        }
            ...
            .done(function (data) {
                ...
                if (data.warning != null) {
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            location.href = "${pageContext.request.contextPath}/task";
                        }, 2000);
                    }, 500);
                }
                else {
