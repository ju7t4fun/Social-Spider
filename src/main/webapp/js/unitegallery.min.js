...
function UGVideoPlayer() {
    ...
    this.init = function (e, t, i) {
        ...
        t += "<div class='ug-videoplayer-wrapper ug-videoplayer-youtube' style='display:none'><div id='" + I.youtubeInnerID + "'></div></div>", t += "<div id='" + I.VKONTAKTEPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-VKONTAKTE' style='display:none'>"+ frm +"</div>", t += "<div id='" + I.html5PlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-html5'></div>", t += "<div id='" + I.soundCloudPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-soundcloud'></div>", t += "<div id='" + I.wistiaPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-wistia'></div>", 0 == I.standAloneMode && 1 == w.video_enable_closebutton && (t += "<div class='cccc'></div>"), t += "</div>", e.append(t), a = e.children(".ug-videoplayer"), s = a.children(".ug-videoplayer-youtube"), l = a.children(".ug-videoplayer-VKONTAKTE"), u = a.children(".ug-videoplayer-html5"), _ = a.children(".ug-videoplayer-soundcloud"), g = a.children(".ug-videoplayer-wistia"), 0 == I.standAloneMode && 1 == w.video_enable_closebutton && (d = a.children(".cccc"))
    }, this.destroy = function () {
