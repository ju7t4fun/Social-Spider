...
function deleteConfirmCreatedPost(id) {
    ...
    function confirm() {
        ...
        xmlhttp.open('GET', '${pageContext.request.contextPath}/post?action=remove&id=' + id, true);
...
function deleteConfirmQueuedPost(id) {
    ...
    function confirm() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open("POST", "${pageContext.request.contextPath}/post?action=deletenewpost", true);
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4) {
                var response = JSON.parse(xmlhttp.responseText);
                toastrNotification(response.status, response.msg);
...
function deleteConfirmOwner(id) {
    ...
    function confirm() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open('GET', '${pageContext.request.contextPath}/owner?action=remove&id=' + id, true);
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4) {
                var response = JSON.parse(xmlhttp.responseText);
                toastrNotification(response.status, response.msg);
...
function deleteConfirmPosted(id) {
    ...
    function confirm() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open("GET", "${pageContext.request.contextPath}/post?action=deleteNewPost&post_id=" + id, true);
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4) {
                var response = JSON.parse(xmlhttp.responseText);
                toastrNotification(response.status, response.msg);
...
function deleteConfirmProfile(id) {
    ...
    function confirm() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open('GET', '${pageContext.request.contextPath}/accounts?action=remove&id=' + id, true);
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4) {
                var response = JSON.parse(xmlhttp.responseText);
                toastrNotification(response.status, response.msg);
...
function deleteConfirmCategory(id) {
    ...
    function confirm() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open('GET', '${pageContext.request.contextPath}/admin/categories?action=removecategory&id=' + id, true);
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4) {
                var response = JSON.parse(xmlhttp.responseText);
                toastrNotification(response.status, response.msg);
