...
function UGCarousel() {
    ...
    function g(e, t, i) {
        ...
        for (var r = [], o = 0; t > o; o++) {
            if ("prev" == i)var a = U.getPrevItem(n, !0); else var a = U.getNextItem(n, !0);
    ...
    function c() {
        var e = V.getElementSize(F), t = V.getElementSize(W), i = t.width - e.width + t.left, n = K.sideSpace - i;
        return n
    }

    function h() {
        var e = -r(), t = K.sideSpace - e;
        return t
    }
    ...
    function I(e, t, i) {
        ...
        var n = u(e), r = V.getElementSize(n), o = -r.left + q.carousel_padding, a = {left: o + "px"};
        if (t === !0) {
            var s = q.carousel_scroll_duration, l = q.carousel_scroll_easing;
    ...
    function P() {
        var e = -r(), t = s(e), i = V.getElementSize(u(t)).left, n = V.getElementSize(u(t + 1)).left;
    ...
    function S() {
        ...
        if (e > K.spaceActionSize)i = s(e), b(i, "left"), K.numCurrent += i; else if (e < -K.spaceActionSize) {
            var r = s(Math.abs(e));
    ...
    function z(e) {
        ...
        K.lastMousePos = o(e);
        var i = K.lastMousePos - K.startMousePos, n = K.startInnerPos + i, r = i > 0 ? "prev" : "next", a = V.getElementSize(W).width;
    ...
    function Q() {
        var e = K.lastTime - K.startTime, t = Math.abs(K.lastMousePos - K.startMousePos);
        return e > 300 ? !1 : t > 30 ? !1 : !0
    }

    var G, R, D, F, W, Y = this, B = jQuery(this), U = new UniteGalleryMain, V = new UGFunctions, X = new UGTileDesign, Z = new UGThumbsGeneral, q = {
        carousel_padding: 8,
...
function UniteGalleryMain() {
        ...
        for (var t = 0, i = 0; i < e.length; i++) {
            ...
            switch (s.type) {
                case"youtube":
                    ...
                    break;
                case"VKONTAKTE":
                    vk_video = n.data("videoid");
                    s.videoid = n.data("videoid"), g_temp.isVKONTAKTEPresent = !0;
                    break;
                case"html5video":
    ...
    function loadAPIs() {
        g_temp.isYoutubePresent && g_ugYoutubeAPI.loadAPI(), g_temp.isVKONTAKTEPresent && g_ugVKONTAKTEAPI.loadAPI(), g_temp.isHtml5VideoPresent && g_ugHtml5MediaAPI.loadAPI(), g_temp.isSoundCloudPresent && g_ugSoundCloudAPI.loadAPI(), g_temp.isWistiaPresent && g_ugWistiaAPI.loadAPI()
    }
    ...
    var t = this, g_galleryID, g_objGallery = jQuery(t), g_objWrapper, g_objThumbs, g_objSlider, g_functions = new UGFunctions, g_arrItems = [], g_numItems, g_selectedItem = null, g_selectedItemIndex = -1, g_objTheme;
    this.events = {
...
function UGGridPanel() {
    ...
    function a() {
        var e = M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom, t = k.panelHeight - e;
        if (0 == M.gridpanel_arrows_always_on) {
            var i = A.getNumPanesEstimationByHeight(t);
            if (1 == i)return t
        }
        var n = j.getElementSize(P), r = n.height, e = r + M.gridpanel_arrows_padding_vert;
    ...
    function s() {
        var e = M.gridpanel_padding_border_left + M.gridpanel_padding_border_right, t = k.panelWidth - e;
        if (0 == M.gridpanel_arrows_always_on) {
            var i = A.getNumPanesEstimationByWidth(t);
            if (1 == i)return t
        }
        var n = j.getElementSize(P), r = n.width;
    ...
    function g() {
        ...
        var i = _(), n = A.getElement();
        j.placeElement(n, i, e, 0, t)
    }

    function c() {
        var e, t, i, n, r = j.getElementSize(E), o = A.getSize();
        ...
        switch (M.gridpanel_arrows_align_vert) {
            ...
            case"center":
            case"middle":
                t = (o.top - r.height) / 2, i = o.bottom + (k.panelHeight - o.bottom - r.height) / 2, n = 0;
                break;
            case"grid":
    ...
    function p() {
        var e, t, i, n, r = j.getElementSize(E), o = A.getSize(), a = M.gridpanel_padding_border_top;
        switch (M.gridpanel_grid_align) {
            case"middle":
                switch (M.gridpanel_arrows_align_vert) {
                    default:
        ...
        switch (M.gridpanel_arrows_align_vert) {
            ...
            case"center":
            case"middle":
                e = o.bottom + (k.panelHeight - o.bottom - r.height) / 2, i = 0;
                break;
            case"grid":
    ...
    function m() {
        ...
        switch (M.gridpanel_arrows_align_hor) {
            ...
            case"grid":
                ...
                break;
            case"center":
                t = (o.left - r.width) / 2, i = o.right + (k.panelWidth - o.right - r.width) / 2
        }
    ...
    var w, I, P, E, S = this, T = jQuery(this), x = new UniteGalleryMain, j = new UGFunctions, A = new UGThumbsGrid, C = new UGPanelsBase;
    ...
    }, z = {gridpanel_grid_align: "center"}, k = {
        panelType: "grid",
        isHorType: !1,
        arrowsVisible: !1,
        panelHeight: 0,
...
function UGLightbox() {
    ...
    function o() {
        ...
        var e = q.height();
        if (0 == e)return !1;
        var t = e, i = tt.getSize().height;
        e != nt.topPanelHeight && (t = nt.topPanelHeight), i > t && (t = i), e != t && (q.height(t), $ && 0 == $.isAnimating() && r(t))
    }

    function a(e) {
        var t = {}, i = it.lightbox_textpanel_width, n = 47, r = 40, a = e.width - n - r;
    ...
    function s(e) {
        ...
        if (!tt)return !1;
        if (!$)return !1;
        var t = et.getElementSize(Y), i = tt.getSize();
        if (0 == i.width || i.height > 120)return !1;
        if (!e)var n = $.getSlideImage(), e = et.getElementSize(n);
        if (0 == e.height || 0 == e.width)return !1;
        var r = e.bottom + i.height;
        if (r < t.height)return !1;
        var o = $.getOptions(), a = i.height;
    ...
    function l(e, t) {
        if (!e)var i = $.getSlideImage(), e = et.getElementSize(i);
        nt.textPanelTop = e.bottom, t === !0 && tt.positionPanel(nt.textPanelTop, nt.textPanelLeft)
    }

    function u(e) {
        var t = (et.getElementSize(Y), $.getSlideImage()), i = et.getElementSize(t);
    ...
    function g(e, t) {
        ...
        var i = d(), n = 2, r = et.getElementRelativePos(X, "right", 2, Y);
        if (0 == i)var o = n, a = r; else {
            var s = $.getSlideImage(), l = et.getElementSize(s), u = et.getElementSize($.getElement()), _ = et.getElementSize(X);
            u.top == u.height && (u.top = 0);
            var a = u.left + l.right - _.width / 2 + it.lightbox_compact_closebutton_offsetx, o = u.top + l.top - _.height / 2 - it.lightbox_compact_closebutton_offsety;
            n > o && (o = n), a > r && (a = r)
        }
        if (t === !0) {
            var g = {left: a, top: o};
            X.stop().animate(g, {duration: nt.fadeDuration})
    ...
    function h() {
        ...
        if ($) {
            if (q) {
                var o = q.height(), s = {slider_image_padding_top: o, slider_video_padding_top: o};
                $.setOptions(s)
            }
    ...
    function m() {
        ...
        var e = {pageX: nt.lastMouseX, pageY: nt.lastMouseY}, t = $.isMouseInsideSlideImage(e);
        return t
    }
    ...
    function P(e) {
        if (!Z)return !1;
        if (!e)var e = $.getCurrentItem();
        var t = J.getNumItems(), i = e.index + 1;
        Z.html(i + " / " + t)
    }
    ...
    function C() {
        var e = $.getOptions(), t = e.slider_image_padding_top;
        if (q) {
            var i = q.height();
            i != t && r(i)
        }
    ...
    var W, Y, B, U, V, X, Z, q, K = this, J = (jQuery(this), new UniteGalleryMain), $ = new UGSlider, et = new UGFunctions, tt = new UGTextPanel, it = {
        lightbox_type: "wide",
...
function UGSlider() {
    function e(e, t, n) {
        ...
        if (et = r.g_objWrapper, tt = r.g_objThumbs, t.hasOwnProperty("slider_progress_indicator_type") && (Pt.slider_progress_indicator_type = t.slider_progress_indicator_type), "bar" == Pt.slider_progress_indicator_type && (Pt = jQuery.extend(Pt, Et)), t && ct.setOptions(t), i(), 1 == Pt.slider_enable_bullets) {
            vt = new UGBullets;
            var o = {bullets_skin: Pt.slider_bullets_skin, bullets_space_between: Pt.slider_bullets_space_between};
            vt.init(pt, o)
        }
    ...
    function i() {
        var e = pt.getOptions(), t = e.gallery_skin;
    ...
    function n(e, t) {
        ...
        return "round" == Pt.slider_videoplay_button_type && (i = "ug-type-round"), html = "", html += "<div" +
            " class='ug-slide-wrapper ug-slide" + t + "'>", html += "<div class='ug-item-wrapper'></div>", html += "<div class='ug-slider-preloader " + e + "'></div>", html += "<div class='ug-button-videoplay " + i + "' style='display:none'></div>", html += "</div>"
    }

    function r(e) {
        e && (et = e);
        var t = V(), i = (pt.getOptions(), "<div class='ug-slider-wrapper'>");
        ...
        if (1 == Pt.slider_enable_text_panel)if (0 == Pt.slider_textpanel_always_on && 0 == Pt.slider_controls_always_on)It.appendHTML(it); else if (It.appendHTML(it), 0 == Pt.slider_textpanel_always_on) {
            var o = It.getElement();
    ...
    function u() {
        var e, t, i, n, r = ct.getSlidesReference(), o = 0, a = 0, s = 0;
    ...
    function _(e, t) {
        ...
        switch (e) {
            case"right":
                ...
                var r = yt.getElementSize(n.objPrevSlide), o = -r.left;
                ct.switchSlideNums("right");
                break;
            case"left":
                y(n.objNextSlide, t), u();
                var a = yt.getElementSize(n.objNextSlide), o = -a.left;
                ct.switchSlideNums("left");
                break;
            default:
                throw new Error("wrong direction: " + e)
        }
        var s = Pt.slider_transition_speed, l = Pt.slider_transition_easing;
        nt.animate({left: o + "px"}, {
    ...
    function f() {
        var e = Pt.slider_video_constantsize_width, t = Pt.slider_video_constantsize_height;
    ...
    function v(e, t) {
        var i = Pt.slider_video_constantsize_width, n = Pt.slider_video_constantsize_height, r = Pt.slider_video_constantsize_scalemode;
        yt.scaleImageExactSizeInParent(e, t.imageWidth, t.imageHeight, i, n, r)
    }

    function b(e, t, i) {
        var n = e.children(".ug-item-wrapper"), r = q(e), o = t.urlImage, a = e.data("urlImage");
        e.data("urlImage", o);
        var s = ct.getScaleMode(e), l = ct.getSlideType(e);
        if (objPadding = ct.getObjImagePadding(), a == o && i !== !0) {
            ...
            e.fadeTo(0, 1);
            var i = e.parent().parent(), n = ct.getSlideType(i), r = q(i), o = ct.getObjImagePadding(), a = ct.getScaleMode(i);
    ...
    function P() {
        var e = It.getElement(), t = e.data("isHidden");
        return t === !1 ? !1 : !0
    }
    ...
    function Y(e, t) {
        t = jQuery(t);
        var i = ct.getSlideImage(t), n = K(t), r = yt.getElementSize(i);
    ...
    function Z(e) {
        var t = ct.getSlidesReference(), i = t.objCurrentSlide.data("index"), n = e.index, r = "left";
    ...
    var $, et, tt, it, nt, rt, ot, at, st, lt, ut, dt, _t, gt, ct = this, ht = jQuery(ct), pt = new UniteGalleryMain, ft = null, mt = null, vt = null, bt = new UGVideoPlayer, yt = new UGFunctions, wt = null, It = null;
    this.events = {
    ...
    this.destroy = function () {
        ...
        var e = ct.getSlidesReference(), t = yt.getElementSize(e.objCurrentSlide), i = -t.left, n = yt.getElementSize(nt);
        return i == n.left ? !0 : !1
        ...
        var e = {objPrevSlide: X(St.numPrev), objNextSlide: X(St.numNext), objCurrentSlide: X(St.numCurrent)};
        return e
    }, this.getCurrentSlide = function () {
        var e = ct.getSlidesReference();
        return e.objCurrentSlide
    }, this.getCurrentItemIndex = function () {
        var e = ct.getSlidesReference(), t = e.objCurrentSlide.data("index");
        ...
        var t = ct.getSlideImage(), i = yt.getMousePosition(e);
        void 0 === i.pageX && (i = ut.getLastMousePos());
        var n = yt.getMouseElementPoint(i, t), r = yt.getElementSize(t);
        ...
        var i = ct.getSlidesReference(), n = i.objCurrentSlide.data("index"), r = e.index;
        if (r == n)return !0;
        var o = void 0 == n;
        if (o)y(i.objCurrentSlide, e), ct.placeNabourItems(); else {
            var a = "left", s = pt.getNumItems();
            n == s - 1 && 0 == r ? a = "left" : 0 == n && r == s - 1 ? a = "right" : n > r && (a = "right"), d(a, e, t)
        }
    }, this.placeNabourItems = function () {
        var e = ct.getSlidesReference(), t = e.objCurrentSlide.data("index"), i = pt.getPrevItem(t), n = pt.getNextItem(t);
    ...
    }, this.stopSlideAction = function (e) {
        ...
        var e = {g_objSlider: it, g_objInner: nt, g_options: Pt, g_objZoomSlider: dt};
        return e
        ...
        var t = ct.getScaleMode(), i = ct.getObjImagePadding(), n = J(), r = e.parent(), o = yt.getImageInsideParentData(r, n.imageWidth, n.imageHeight, t, i), a = yt.getElementSize(e);
        ...
        var o = e - Pt.slider_item_padding_left - Pt.slider_item_padding_right, s = t - Pt.slider_item_padding_top - Pt.slider_item_padding_bottom, l = {};
        ...
        if ("image" != d && 1 == Pt.slider_video_constantsize)f(); else {
            var _ = e - Pt.slider_video_padding_left - Pt.slider_video_padding_right, g = t - Pt.slider_video_padding_top - Pt.slider_video_padding_bottom;
...
function UGStripPanel() {
    function e(e, t) {
        ...
        var n = E.getOptions(), r = n.gallery_skin;
    ...
    function f() {
        ...
        if (M.isEventsInited = !0, y)if (S.addClassOnHover(y, "ug-button-hover"), S.addClassOnHover(w, "ug-button-hover"), S.setButtonOnClick(w, g), S.setButtonOnClick(y, _), "advance_item" != j.strippanel_buttons_role)jQuery(T).on(T.events.STRIP_MOVE, h), m.on(E.events.SIZE_CHANGE, c); else {
            var e = E.getOptions();
    ...
    var m, v, b, y, w, I = this, P = jQuery(this), E = new UniteGalleryMain, S = new UGFunctions, T = new UGThumbsStrip, x = new UGPanelsBase;
    this.events = {FINISH_MOVE: "gridpanel_move_finish", OPEN_PANEL: "open_panel", CLOSE_PANEL: "close_panel"};
    var j = {
...
function UGThumbsGeneral() {
    function e() {
        var e = "", t = E.thumb_image_overlay_type.split(",");
        for (var i in t) {
            var n = t[i];
            switch (n) {
                case"bw":
    ...
    function t(e, t) {
        e.stop(!0).animate(t, {duration: E.thumb_transition_duration, easing: E.thumb_transition_easing, queue: !1})
    }

    function i(e, i, n, r) {
        if (!r)var r = !1;
        I.isFakeFullscreen() && (r = !0);
        var o = e.children(".ug-thumb-border-overlay"), a = {};
    ...
    function n(e, t, i) {
        var n = e.children(".ug-thumb-overlay"), r = E.thumb_transition_duration;
        i && i === !0 && (r = 0), t ? n.stop(!0).fadeTo(r, 1) : n.stop(!0).fadeTo(r, 0)
    }

    function r(e, t, i) {
        var n = e.children("img.ug-thumb-image"), r = e.children("img.ug-thumb-image-overlay"), o = E.thumb_transition_duration;
    ...
    function l() {
        ...
        var e = {"border-radius": E.thumb_round_corners_radius + "px"};
        b.find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay").css(e)
    }

    function u(e, t) {
        t = jQuery(t);
        var i = (y.getItemByThumb(t), P.getElementSize(t)), n = {width: i.width + "px", height: i.height + "px"};
    ...
    function g(e, t) {
        ...
        if (P.scaleImageCoverParent(i, n), n.children(".ug-thumb-loader").hide(), i.show(), 0 == E.thumb_image_overlay_effect)i.fadeTo(0, 1); else {
    ...
    var p, f, m, v, b, y = this, w = jQuery(y), I = new UniteGalleryMain, P = new UGFunctions;
    this.events = {
    ...
    var E = {
        ...
        isEffectOverlay: !1,
        isEffectImage: !1
    }, T = {timeout_thumb_check: 100, thumb_max_check_times: 600, eventSizeChange: "thumb_size_change"};
    this.init = function (e, t) {
        ...
        for (var r = 0; i > r; r++) {
            ...
            var d = jQuery(s), _ = o.objThumbImage;
            if (0 == S.customThumbs) {
        ...
        if (S.isEffectOverlay && E.thumb_overlay_color) {
            var i = {}, n = P.convertHexToRGB(E.thumb_overlay_color, E.thumb_overlay_opacity);
...
function UGThumbsGrid() {
    ...
    function o() {
        var e = Q.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerHeight(), n = U.gridWidth, r = B.grid_num_rows * i + (B.grid_num_rows - 1) * B.grid_space_between_rows + 2 * B.grid_padding;
        U.gridHeight = r, F.setElementSize(H, n, r), F.setElementSize(Q, n, r), U.innerWidth = n, U.innerHeight = r
    }

    function a() {
        var e = Q.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = B.grid_num_cols * i + (B.grid_num_cols - 1) * B.grid_space_between_cols + 2 * B.grid_padding, r = U.gridHeight;
    ...
    function g() {
        var e = Q.children(".ug-thumb-wrapper"), t = B.grid_padding, n = B.grid_padding, r = n, o = t, a = 0, s = 0, l = 0, u = 0;
    ...
    var z, k, N, L, H, Q, G = this, R = jQuery(this), D = new UniteGalleryMain, F = new UGFunctions, W = new UGThumbsGeneral, Y = new UGTileDesign, B = {
    ...
    this.destroy = function () {
        ...
        if (1 == U.isTilesMode)var t = B.tile_height; else var i = W.getOptions(), t = i.thumb_height;
        var n = W.getNumThumbs(), r = Math.ceil(n / B.grid_num_cols), o = r * t + (r - 1) * B.grid_space_between_rows, a = Math.ceil(o / e);
        return a
    }, this.getNumPanesEstimationByWidth = function (e) {
        if (U.isTilesMode)var t = B.tile_width; else var i = W.getOptions(), t = i.thumb_width;
        var n = W.getNumThumbs(), r = Math.ceil(n / B.grid_num_rows), o = r * t + (r - 1) * B.grid_space_between_cols, a = Math.ceil(o / e);
        return a
    }, this.getHeightEstimationByWidth = function (e) {
        if (0 == U.isTilesMode)throw new Error("This function works only with tiles mode");
        var t = W.getNumThumbs(), i = F.getNumItemsInSpace(e, B.tile_width, B.grid_space_between_cols), n = Math.ceil(t / i);
...
function UGThumbsStrip() {
    ...
    function s() {
        if (0 == O) {
            var e = L.thumbSecondSize, t = {};
            t.height = e + "px";
            var i = {};
            i.height = e + "px"
        } else {
            var n = L.thumbSecondSize, t = {};
            t.width = n + "px";
            var i = {};
            i.width = n + "px"
        }
    ...
    function d(e) {
        var t = y(e), i = -1 * t.max + L.stripSize;
        i = A.fixInnerStripLimits(i), A.positionInnerStrip(i, !0)
    }
    ...
    var w, I, P, E, S, T, x, j, A = this, C = new UniteGalleryMain, M = new UGFunctions, O = !1, z = new UGThumbsGeneral, M = new UGFunctions, k = {
    ...
    }, N = {isRunOnce: !1, is_placed: !1}, L = {stripSize: 0, stripInnerSize: 0, thumbSize: 0, thumbSecondSize: 0};
    this.events = {STRIP_MOVE: "stripmove"};
    var H = {strip_thumbs_align: "top"};
    this.setHtml = function (e) {
        if (!e) {
            var e = P;
        ...
        if (void 0 === t)var t = !1;
        if (0 == O)var i = {left: e + "px"}; else var i = {top: e + "px"};
        ...
        if (0 == O)var r = n + S.width(), o = i.left, a = i.left + t.width(); else var r = n + S.height(), o = i.top, a = i.top + t.height();
        var s = !1;
        ...
        var e = z.getOptions(), t = jQuery.extend(k, e), i = {
            g_gallery: C,
            g_objGallery: w,
            g_objWrapper: P,
            g_arrItems: E,
...
function UGTileDesign() {
    ...
    function i(e, t) {
        ...
        if (1 == z.tile_enable_image_effect) {
            var _ = "<div class='ug-tile-image-overlay' style='display:none'>", g = " ug-" + z.tile_image_effect_type + "-effect";
    ...
    function g(e) {
        var t = (j.getItemByTile(e), u(e)), i = l(e), d = M.getElementSize(e), _ = r(e), g = n(e), c = o(e);
        ...
        if (1 == z.tile_enable_textpanel && h && h.refresh(), t || i) {
            var p = 0;
            if (1 == z.tile_enable_textpanel) {
                var f = s(e), m = M.getElementSize(f);
                m.height > 0 && (p = Math.floor(m.height / 2 * -1))
            }
        }
        if (t && i) {
            var v = M.getElementSize(t), b = M.getElementSize(i), y = z.tile_space_between_icons, w = v.width + y + b.width, I = Math.floor((d.width - w) / 2);
    ...
    function c(e, t) {
        var i = (j.getItemByTile(e), r(e)), o = z.thumb_transition_duration;
    ...
    function h(e, t) {
        var i = z.thumb_transition_duration, n = s(e);
        if (!n)return !0;
        if ("slide" == z.tile_textpanel_appear_type) {
            var r = M.getElementSize(n);
            if (0 == r.width)return !1;
            var o = -r.height, a = 0;
            1 == t ? (n.fadeTo(0, 1), 0 == n.is(":animated") && n.css("bottom", o + "px"), n.stop(!0).animate({bottom: a + "px"}, i)) : n.stop(!0).animate({bottom: o + "px"}, i)
    ...
    function w(e) {
        ...
        if (N.funcParentApproveClick && 0 == N.funcParentApproveClick() && (n = !1), "a" == i)0 == n && e.preventDefault(); else if (0 == d(t))1 == n && y(t); else {
            if (0 == _(t))return !0;
    ...
    var E, S, T, x, j = this, A = jQuery(this), C = new UniteGalleryMain, M = new UGFunctions, O = new UGThumbsGeneral;
    ...
    }, N = {isFixedMode: !1, eventSizeChange: "thumb_size_change", funcParentApproveClick: null};
...
function UGTiles() {
    ...
    function s(e, t, i) {
        ...
        var o = P.getElementSize(e), s = o.height, l = T.arrPosx[n];
    ...
    function u() {
        ...
        if (1 == x.tiles_set_initial_height && 0 == P.isScrollbarExists() && 25 > t) {
            var n = (e.length, Math.ceil(e.length / T.numCols)), a = n * x.tiles_col_width * .75;
            v.height(a), r()
        }
        var s = T.numCols, u = T.galleryWidth, d = jQuery(v).find("img.ug-thumb-image"), _ = !1;
    ...
    function d() {
        var e = n(), t = S.getThumbs(), i = x.tiles_justified_row_height, r = [], o = 0, a = x.tiles_justified_space_between, s = t.length;
        jQuery.each(t, function (e, t) {
            t = jQuery(t);
            var n = P.getElementSize(t), a = n.width, s = n.height;
        ...
        jQuery.each(d, function (t, n) {
            var o = (n.length, g[t]), s = (n.length - 1) * a, l = (e - s) / o, u = Math.round(i * l);
            v += u, t > 0 && (v += a), m.push(u);
            var d = u / i, _ = [], c = s;
            jQuery.each(n, function (e, t) {
                var i = jQuery(t), n = i.index(), o = r[n], a = Math.round(o * d);
                _[e] = a, c += a
            });
            var h = c - e;
    ...
    function _(e) {
        ...
        jQuery.each(i.arrRows, function (t, n) {
            var r = i.arrRowWidths[t], s = i.arrRowHeights[t], l = 0;
            jQuery.each(n, function (t, n) {
                var u = jQuery(n), d = s, _ = r[t];
    ...
    function g() {
        var e = jQuery(m).find("img.ug-thumb-image"), t = S.getThumbs();
    ...
    var f, m, v, b, y = this, w = jQuery(this), I = new UniteGalleryMain, P = new UGFunctions, E = new UGTileDesign, S = new UGThumbsGeneral, T = {}, x = {
        tiles_type: "columns",
        tiles_col_width: 250,
    ...
    var j = {isFirstTimeRun: !0, handle: null};
    this.destroy = function () {
...
function UGTouchSliderControl() {
    ...
    function t() {
        ...
        if (20 > r)return !1;
        var o = jQuery.now(), a = o - y.startTime;
        return 500 > a ? !0 : !1
    }
    ...
    function i(e) {
        ...
        h.animate({left: i + "px"}, {
            ...
            progress: function () {
                if (1 == y.isDragVideo) {
                    var e = b.getElementSize(h), t = e.left, n = t - i, r = y.videoStartX + n;
    ...
    function r() {
        ...
        switch (o) {
            case"right":
                if (m.isSlideHasItem(t.objPrevSlide))var s = b.getElementSize(t.objPrevSlide), l = -s.left; else a = !0;
                break;
            case"left":
                if (m.isSlideHasItem(t.objNextSlide))var u = b.getElementSize(t.objNextSlide), l = -u.left; else a = !0
        }
        1 == a ? i(t) : h.stop().animate({left: l + "px"}, {
            ...
            progress: function () {
                if (1 == y.isDragVideo) {
                    var e = b.getElementSize(h), t = e.left, i = t - y.startPosx, n = y.videoStartX + i;
    ...
    function o(e) {
        ...
        if (0 == y.isDragging && (y.isDragging = !0, p.trigger(m.events.START_DRAG)), h.css("left", o + "px"), 1 == y.isDragVideo) {
            var u = o - y.startPosx, d = y.videoStartX + u;
    ...
    function _(e) {
        var n = b.getArrTouches(e), o = n.length, a = m.isInnerInPlace();
        if (1 == a && 0 == y.touch_active && 0 == o)return !0;
        if (0 == o && 1 == y.touch_active) {
            1 == a && jQuery(v).trigger(v.events.CLICK), s("3");
            var u = !1, d = b.wasVerticalScroll(y.storedEventID);
            0 == d && (u = t()), 1 == u ? r() : i()
    ...
    var c, h, p, f, m = new UGSlider, v = this, b = new UGFunctions;
    ...
    this.isTapEventOccured = function (t) {
        ...
        y.lastNumTouches = n;
        var r = m.getSlidesReference(), o = (e(r), Math.abs(y.lastMouseX - y.startMouseX)), a = Math.abs(y.lastMouseY - y.startMouseY), s = jQuery.now(), l = s - y.startTime;
        ...
        var e = {pageX: y.lastMouseX, pageY: y.lastMouseY};
        return e
...
function UGTouchThumbsControl() {
    ...
    function n(e) {
        var t = E.mousePos - e, i = E.innerPos - t, n = h.getInnerStripLimits();
        if (i > n.maxPos) {
            var r = i - n.maxPos;
            i = n.maxPos + r / 3
        }
    ...
    function o() {
        var e = jQuery.now(), t = e - E.lastTime;
    ...
    function a() {
        var e = P.thumb_touch_slowFactor, t = P.minDeltaTime, i = P.minPath, n = h.getInnerStripPos(), r = jQuery.now(), o = r - E.lastTime, a = n - E.lastPortionPos;
        t > o && E.lastDeltaTime > 0 && (o = E.lastDeltaTime, a = E.lastDeltaPos + a), t > o && (o = t);
        var l = a > 0 ? 1 : -1, u = 0;
        o > 0 && (u = a / o);
        var d = u * u / (2 * e) * l;
        Math.abs(d) <= i && (d = 0);
        var _ = h.getInnerStripPos(), g = _ + d, c = h.fixInnerStripLimits(g), p = h.getInnerStripLimits(), f = P.limitsBreakAddition, m = !1, v = c;
        ...
        if (1 == m) {
            var x = P.returnAnimateSpeed, j = {left: v + "px"};
    ...
    var h, p, f, m, v, b, y, w, I = new UGFunctions, P = {
...
function UGVKONTAKTEAPI() {
    ...
    function t(e, t, n, o, a) {
        s = null, l = !1;
        //var u = t;
        var u = 'http://vk.com/video_ext.php?oid=16697463&id=171361804&hash=0089d6a9aa4c5a4a&api_hash=1436283388b9bd4c6cdc40850774';
        a === !0 && (u += "");
        var d = "<iframe src=" + u + " width='" + n + "' height='" + o + "'></iframe>";
        jQuery("#" + e).html(d);
    ...
    this.events = {START_PLAYING: "start_playing", STOP_PLAYING: "stop_playing"}, this.loadAPI = function () {
        //return 1 == g_ugVKONTAKTEAPI.isAPILoaded ? !0 : e() ? (g_ugVKONTAKTEAPI.isAPILoaded = !0, !0) : (g_ugFunctions.loadJs("f.VKONTAKTEcdn.com/js/froogaloop2.min.js", !0), void(g_ugVKONTAKTEAPI.isAPILoaded = !0))
       // return void(g_ugVKONTAKTEAPI.isAPILoaded = !0))
      //  var u =
      ////
      // 'http://vk.com/video_ext.php?oid=16697463&id=171361804&hash=0089d6a9aa4c5a4a&api_hash=1436283388b9bd4c6cdc40850774';
    //    var d = "<iframe src=" + u + " width="300" height="300"></iframe>";
        var fadfasd = '<iframe style="margin-left: -410px; margin-top: -200px;" width="900" height="500" src="'+ vk_video +'"></iframe>';;
        return fadfasd;
        alert(vk_video);
    }, this.doCommand = function (e) {
        if (null == s)return !1;
        ...
        var n = location.protocol + "//VKONTAKTE.com/api/v2/video/" + e + ".json";
...
function UGVideoPlayer() {
    ...
    function r(e) {
        var t = ["youtube", "VKONTAKTE", "html5", "soundcloud", "wistia"];
        for (var i in t) {
            var n = t[i];
            if (n != e)switch (n) {
                case"youtube":
    ...
    var o, a, s, l, u, d, _, g, c = this, h = jQuery(this), p = new UGFunctions, f = new UGYoutubeAPI, m = new UGVKONTAKTEAPI, v = new UGHtml5MediaAPI, b = new UGSoundCloudAPI, y = new UGWistiaAPI, w = {video_enable_closebutton: !0};
    this.events = {
        SHOW: "video_show",
        HIDE: "video_hide",
    ...
    this.init = function (e, t, i) {
        ...
        I.youtubeInnerID = o + "_youtube_inner", I.VKONTAKTEPlayerID = o + "_videoplayer_VKONTAKTE", I.html5PlayerID = o + "_videoplayer_html5", I.wistiaPlayerID = o + "_videoplayer_wistia", I.soundCloudPlayerID = o + "_videoplayer_soundcloud";
        var t = "<div class='ug-videoplayer' style='display:none'>";
        var frm  = '<iframe style="margin-top: -20px;" width="900" height="450" src="'+ vk_video +'"></iframe>';

        t += "<div class='ug-videoplayer-wrapper ug-videoplayer-youtube' style='display:none'><div id='" + I.youtubeInnerID + "'></div></div>", t += "<div id='" + I.VKONTAKTEPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-VKONTAKTE' style='display:none'>"+ frm +"</div>", t += "<div id='" + I.html5PlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-html5'></div>", t += "<div id='" + I.soundCloudPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-soundcloud'></div>", t += "<div id='" + I.wistiaPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer-wistia'></div>", 0 == I.standAloneMode && 1 == w.video_enable_closebutton && (t += "<div class='ug-videoplayer-button-close'></div>"), t += "</div>", e.append(t), a = e.children(".ug-videoplayer"), s = a.children(".ug-videoplayer-youtube"), l = a.children(".ug-videoplayer-VKONTAKTE"), u = a.children(".ug-videoplayer-html5"), _ = a.children(".ug-videoplayer-soundcloud"), g = a.children(".ug-videoplayer-wistia"), 0 == I.standAloneMode && 1 == w.video_enable_closebutton && (d = a.children(".ug-videoplayer-button-close"))
    }, this.destroy = function () {
    ...
    }, this.playVKONTAKTE = function (e, t) {
        if ("undefined" == typeof t)var t = !0;
        r("VKONTAKTE"), l.show(), m.isPlayerReady() && 1 == I.standAloneMode ? m.changeVideo(e, t) : m.putVideo(I.VKONTAKTEPlayerID, e, "100%", "100%", t)
...
function UGZoomSliderControl() {
    ...
    function n(e, i) {
        var n = P.getSlidesReference(), r = n.objCurrentSlide.find("img"), o = t();
        I.trigger(P.events.ZOOM_START);
        var a = !0, s = P.getObjImagePadding();
        if ("back" == e) {
    ...
    function s(e) {
        ...
        var t = E.getMousePosition(e), i = (t.pageX - T.startMouseX, t.pageY - T.startMouseY, t.pageX - T.lastMouseX), n = t.pageY - T.lastMouseY, r = 0 > i ? "left" : "right", o = 0 > n ? "up" : "down";
    ...
    function l() {
        var e = !1, t = !1, i = 0, n = 0, r = E.getElementSize(T.objImage), o = P.getObjImagePadding(), a = E.getElementCenterPosition(T.objImage, o);
    ...
    function c(e) {
        var t = E.getArrTouches(e), i = E.getDistance(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY), n = i / T.startDistance, r = E.getMiddlePoint(t[0].pageX, t[0].pageY, t[1].pageX, t[1].pageY), o = T.objImageSize.width * n, a = T.objImageSize.height * n, s = E.getImageOriginalSize(T.objImage), l = 1;
    ...
    function f(e) {
        ...
        i();
        if (void 0 == T.objImage || 0 == T.objImage.length)return !0;
        var n = T.isPanActive, o = T.isZoomActive;
    ...
    function v(e, t) {
        ...
        if (0 == P.isCurrentSlideType("image"))return !0;
        e.preventDefault();
        var i = t > 0, r = E.getMousePosition(e), o = 1 == i ? "in" : "out";
        n(o, r)
    }
    ...
    var y, w, I, P = new UGSlider, E = new UGFunctions, S = {
...
var g_ugYoutubeAPI = new UGYoutubeAPI, g_ugVKONTAKTEAPI = new UGVKONTAKTEAPI, g_ugHtml5MediaAPI = new UGHtml5MediaAPI, g_ugSoundCloudAPI = new UGSoundCloudAPI, g_ugWistiaAPI = new UGWistiaAPI;